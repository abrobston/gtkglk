...
gtk_vpaned_get_type (void)
{
  ...
  if (!vpaned_type)
	...
	NULL
      ...
      vpaned_type = g_type_register_static (GTK_TYPE_PANED, "GtkVGlkPaned",
					    &vpaned_info, 0);
    }
...
gtk_vpaned_class_init (GtkVPanedClass *class)
{
  ...
  widget_class->button_release_event = glkpaned_button_release;

  g_signal_new("position_changed",
              G_TYPE_FROM_CLASS(class),
              G_SIGNAL_RUN_LAST,
              G_STRUCT_OFFSET(GtkHPaned, position_changed),
              NULL, NULL,
