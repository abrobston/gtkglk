...
extern void glk_put_char_ucs4(glui32 ch);
extern void glk_put_string_ucs4(glui32 *s);
extern void glk_put_buffer_ucs4(glui32 *buf, glui32 len);
extern void glk_put_char_stream_ucs4(strid_t str, glui32 ch);
extern void glk_put_string_stream_ucs4(strid_t str, glui32 *s);
extern void glk_put_buffer_stream_ucs4(strid_t str, glui32 *buf, glui32 len);
